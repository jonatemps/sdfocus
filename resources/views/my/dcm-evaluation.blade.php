    ...
    <div class="rounded bg-white mb-3 p-3">
        <div class="row">
            ...
            <div class="col align-self-end">
              <H6 class="mb-3">MAJ du Vendedi 25 Août, 2023</H6>
            </div>
          </div>
        <div class="border-dashed align-items-center w-100 rounded overflow-hidden" style="min-height: 250px;">
            ...
            <div class="row g-0 shadow p-3 mb-4 rounded" style="border-bottom: inset;">
                ...
                <div class="col-12 d-flex"><p><span>Target : </span> {{$evaluation->obj_etopup}}</p></div>
                <div class="col-5 col-md-4">Réalisation : {{$evaluation->rea_etopup}}</div>
            ...
            <div class="row g-0 shadow p-3 mb-4 rounded" style="border-bottom: inset;">
                <div class="col-12"><h6>SIM Sales Out</h6></div>
